...
public class AccountPage extends BasePage {
    ...
    protected List<Avatar>      _avatars;     ;
    ...
    public AccountPage(MainPanel panel) {
        super(panel, false);
    }
    ...
    public void addComponents(final MainPanel panel) {
        _userManager = new UserManager(IndigoLauncher._launcher._splash);
        _avatars = new ArrayList<Avatar>();
        int padding = 5;
        int btnWidth = 180;
        int btnHeight = 24;
        ...
        IndigoLauncher._launcher.refresh();
    }
    ...
    public final void setResponse(LoginResponse response) {
        IndigoLauncher._launcher.setResponse(response);
    }
